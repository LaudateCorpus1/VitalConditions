$(function() {
  ...
  let viewTable = new Tabulator("#recall-view-available", {
    height: "100%",
    layout: "fitColumns",
    selectable: 1,
    columns: [
  ...
  function updateViewTable() {
    ...
    ///// to get list of files from server.js
    //
    ...
    rows.push({ fullname: 'demo/agency_subcat.microbetrace', name: 'Agency-Subcategory' });
    rows.push({ fullname: 'demo/agency_vitcon.microbetrace', name: 'Agency-Vital_Conditions' });
    rows.push({ fullname: 'demo/opdiv_subcat.microbetrace', name: 'Operating_Division-Subcategory' });
    rows.push({ fullname: 'demo/opdiv_vitcon.microbetrace', name: 'Operating_Division-Vital_Conditions' });
    viewTable.setData(rows);
  }
  ...
  updateViewTable();
  $("#session-recall-view-modal").modal("show");

//  $("#network-statistics-table").hide();
