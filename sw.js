  ...
  event.waitUntil(
    caches.open(CACHE).then(function(cache) {
      return cache.addAll([
        ...
        'img/svg/Basic-Needs.svg',
        'img/svg/Belonging-Civic-Muscle.svg',
        'img/svg/Humane-Housing.svg',
        'img/svg/Lifelong-Learning.svg',
        'img/svg/Meaningful-Work-Wealth.svg',
        'img/svg/Reliable-Transportation.svg',
        'img/svg/Thriving-Natural-World.svg',
        'data/counties.json',
        'data/countries.json',
        'data/stars.json',
        'data/states.json',
